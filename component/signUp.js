...
return<ImageBackground style={styles.contenir} source={require('../assets/1.jpg')}>
    ...
    <View>
        <Text style={styles.label}>Sign up and start Property</Text>
    </View>
    <View>
        <TextInput style={styles.input} placeholder="First Name" placeholderTextColor={'#dddddd'} keyboardType={"default"}></TextInput>
        <TextInput style={styles.input} placeholder="Last Name" placeholderTextColor={'#dddddd'} keyboardType={"default"}></TextInput>
    ...
    <View>
        <TouchableOpacity style={styles.button} onPress={()=>{}} ><Text style={styles.labelyllow}>Sign up</Text></TouchableOpacity>
    </View>
    <View>
        <Text style={styles.labelyllow}>
            Already have an account?
            <Pressable onPress={()=>props.navigation.navigate('SignIn')}><Text style={styles.labelpupler}>    Login</Text></Pressable>
        </Text>
    </View>
</ImageBackground>
}
